...
// The <50% starts the animation after the previous line is 50% done.
tl.fromTo('.cookie', { opacity: 0, x: -50, rotation: '-45deg' }, { opacity: 1, x: 0, rotation: '0deg' }, '<50%')

// The < symbol syncs it with the previous animation
...
// //Using GSAP with animations. First parameter is the element you want to animate
